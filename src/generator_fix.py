...
def generate_fix(data, extra, out_filename="", output_dir=None):
    ...
    if n > 3:
        ...
        for idx, chunk in enumerate(chunks):
            ...
            paths.append(generate_fix(dict(data, items=chunk), extra, fn, output_dir=output_dir))
        return paths

    out_dir.mkdir(exist_ok=True)
    tmp = out_dir / "_working_fix.xlsx"
