...
PRODUCT_ROWS: dict[str, tuple[str, int, int]] = {
    ...
    # ── APT 系列（Sheet: APT）───────────────────────────────────
    "APT20LL": ("APT",  2, 24),  # 23 行
    "APT20M":  ("APT", 26, 47),  # 22 行
    "APT15LL": ("APT", 49, 71),  # 23 行
    "APT15M":  ("APT", 73, 95),  # 23 行
    # ── CPT 系列（Sheet: CPT）───────────────────────────────────
    "CPT20LL": ("CPT",  2, 24),  # 23 行
    "CPT20M":  ("CPT", 26, 47),  # 22 行
    "CPT15LL": ("CPT", 49, 71),  # 23 行
    "CPT15M":  ("CPT", 73, 95),  # 23 行
    # ── AP 油壓台車（Sheet: AP油壓）──────────────────────────────
    ...
    # ── KGZ（Sheet: KGZ）
    "KGZ40-12": ("KGZ",   2,   9),  # 8 行
    "KGZ-40-12DC": ("KGZ",  11,  20),  # 10 行
    "KGZ-40-15": ("KGZ",  22,  29),  # 8 行
